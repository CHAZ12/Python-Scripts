...
def GetVideoID():
    ...
    if r.status_code == 200:
        ...
        if pos != -1:
            ...
            print("Poll: Could not get VideoId User is not live")
            return "Poll: Could not get VideoId User is not live"   
    else:
        print('Page not found')
        return ('Poll: Page not found')
...
def GetContinuation():
    ...
    if r.status_code == 200:
        ...
        if pos != -1:
            ...
            if status == "This video isn't available anymore" or status == "Video unavailable":
